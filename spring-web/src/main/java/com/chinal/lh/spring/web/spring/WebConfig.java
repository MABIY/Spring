...
@Configuration
@EnableWebMvc
@ComponentScan(basePackageClasses = {Components.class, com.chinal.lh.application.Components.class,com.chinal.lh.domain.Components.class,SwaggerConfiguration.class})
